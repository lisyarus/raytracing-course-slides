...
\begin{frame}
\frametitle{Сцена practice3\_1, без MIS, 64 семпла}
\slideimage{practice3_1_uniform.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_1, MIS, 64 семпла}
\slideimage{practice3_1_mis.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_2, без MIS, 64 семпла}
\slideimage{practice3_2_uniform.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_2, MIS, 64 семпла}
\slideimage{practice3_2_mis.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_3, без MIS, 64 семпла}
\slideimage{practice3_3_uniform.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_3, MIS, 64 семпла}
\slideimage{practice3_3_mis.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_4, без MIS, 64 семпла}
\slideimage{practice3_4_uniform.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_4, MIS, 64 семпла}
\slideimage{practice3_4_mis.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_5, без MIS, 64 семпла}
\slideimage{practice3_5_uniform.png}
\end{frame}

\begin{frame}
\frametitle{Сцена practice3\_5, MIS, 64 семпла}
\slideimage{practice3_5_mis.png}
\end{frame}
